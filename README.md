...
* The starter code uses the unsw.dungeon.observer pattern to ensure the frontend and backend are in a consistent state and that they are not tightly coupled. It would be advisable to do the same for the changes you will make.
...
[player]:        images/player/human_new.png
[wall]:          images/worldobject/brick_brown_0.png
[exit]:          images/worldobject/exit.png
[door_open]:     images/worldobject/open_door.png
[door_closed]:   images/worldobject/closed_door.png
[key]:           images/item/key.png
[boulder]:       images/worldobject/boulder.png
[switch]:        images/worldobject/pressure_plate.png
[portal]:        images/worldobject/portal.png
[enemy]:         images/enemy/deep_elf_master_archer_1.png
[sword]:         images/item/greatsword_1_new.png
[invincibility]: images/item/brilliant_blue_new.png
[treasure]:      images/item/gold_pile.png
...
I agree that both members have done equal amounts of work:
*Jonathan*
*Jason*
